...
os.environ["SPOTIPY_CLIENT_ID"] = '3250a6dc4395441d95ea9737269266ae'
os.environ["SPOTIPY_CLIENT_SECRET"] = '882bac7fe2704e63bef0469d3d076aa9'
os.environ["SPOTIPY_REDIRECT_URI"] = 'http://localhost:8080/callback'

scope = 'user-library-read'
username = '31dzi7vtht2ix4sy3tlz2744tvli'
...
rec_df = pd.read_csv(r'rec_song.csv')
